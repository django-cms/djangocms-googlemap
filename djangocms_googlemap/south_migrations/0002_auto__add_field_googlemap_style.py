...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleMap.style'
        db.add_column(u'djangocms_googlemap_googlemap', 'style',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleMap.style'
        db.delete_column(u'djangocms_googlemap_googlemap', 'style')
